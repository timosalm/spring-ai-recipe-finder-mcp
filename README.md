...
*Note: A Spring AI Recipe Finder implementation without MCP is availble [here](https://github.com/timosalm/spring-ai-recipe-finder).*
...
2. Start llama3.1 model (Ollama 0.2.8 or newer, and Llama 3.1 or newer is required for Function Calling)
    ...
    ```
#### Option 2
By enabling the "ollama-compose" Spring profile, the llama3.2 model will be automatically started and configured with docker compose.
